...
class BluePayment extends PaymentModule {
        ...
        try {
            ...
            foreach ( Language::getLanguages( true ) as $lang ) {
                $tab->name[ $lang[ 'id_lang' ] ] =
                    $this->translate( 'Blue Media settings', $lang[ 'iso_code' ], $this->name );
            }
            ...
            PrestaShopLogger::addLog( 'Error adding adminBluepaymentController', 4 );
    ...
    public function addTabInPayments() {
        ...
        try {
            ...
            PrestaShopLogger::addLog( 'Payment tab creation - error', 4 );
            return false;
        }
    ...
    public function removeTabInPayments() {
        ...
        try {
            ...
            PrestaShopLogger::addLog( 'Payment tab remove - error', 4 );
            return false;
        }
