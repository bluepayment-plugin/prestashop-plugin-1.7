...
class Gateway
{
    ...
    public const DATETIME_FORMAT_LONGER = 'Y-m-d H:i:s';
    public const DATETIME_TIMEZONE = 'Europe/Warsaw';
    ...
    public const LOGGER_NAME = 'BM_SDK';
    public const LOG_PATH = 'var/logs/bm-sdk';
    public const MAX_LOG_FILES = 60;
