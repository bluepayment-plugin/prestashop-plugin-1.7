...
class ItnIn extends AbstractModel
{
    ...
    public const PAYMENT_STATUS_DETAILS_AUTHORIZED = 'AUTHORIZED';
    public const PAYMENT_STATUS_DETAILS_ACCEPTED = 'ACCEPTED';
    public const PAYMENT_STATUS_DETAILS_INCORRECT_AMOUNT = 'INCORRECT_AMOUNT';
    public const PAYMENT_STATUS_DETAILS_EXPIRED = 'EXPIRED';
    public const PAYMENT_STATUS_DETAILS_CONFIRMED = 'CONFIRMED';
    public const PAYMENT_STATUS_DETAILS_CANCELLED = 'CANCELLED';
    public const PAYMENT_STATUS_DETAILS_ANOTHER_ERROR = 'ANOTHER_ERROR';
    public const PAYMENT_STATUS_DETAILS_REJECTED = 'REJECTED';
    public const PAYMENT_STATUS_DETAILS_REJECTED_BY_USER = 'REJECTED_BY_USER';
    ...
    public const VERIFICATION_STATUS_POSITIVE = 'POSITIVE';
    public const VERIFICATION_STATUS_NEGATIVE = 'NEGATIVE';

    public const VERIFICATION_STATUS_REASON_NAME = 'NAME';
    public const VERIFICATION_STATUS_REASON_NRB = 'NRB';
    public const VERIFICATION_STATUS_REASON_TITLE = 'TITLE';
    public const VERIFICATION_STATUS_REASON_STREET = 'STREET';
    public const VERIFICATION_STATUS_REASON_HOUSE_NUMBER = 'HOUSE_NUMBER';
    public const VERIFICATION_STATUS_REASON_STAIRCASE = 'STAIRCASE';
    public const VERIFICATION_STATUS_REASON_PREMISE_NUMBER = 'PREMISE_NUMBER';
    public const VERIFICATION_STATUS_REASON_POSTAL_CODE = 'POSTAL_CODE';
    public const VERIFICATION_STATUS_REASON_CITY = 'CITY';
    public const VERIFICATION_STATUS_REASON_BLACKLISTED = 'BLACKLISTED';
    public const VERIFICATION_STATUS_REASON_SHOP_FORMAL_REQUIREMENTS = 'SHOP_FORMAL_REQUIREMENTS';
    public const VERIFICATION_STATUS_REASON_NEED_FEEDBACK = 'NEED_FEEDBACK';

    public const VERIFICATION_STATUSES = [
        self::VERIFICATION_STATUS_REASON_NAME,
        self::VERIFICATION_STATUS_REASON_NRB,
        self::VERIFICATION_STATUS_REASON_TITLE,
        self::VERIFICATION_STATUS_REASON_STREET,
        self::VERIFICATION_STATUS_REASON_HOUSE_NUMBER,
        self::VERIFICATION_STATUS_REASON_STAIRCASE,
        self::VERIFICATION_STATUS_REASON_PREMISE_NUMBER,
        self::VERIFICATION_STATUS_REASON_POSTAL_CODE,
        self::VERIFICATION_STATUS_REASON_CITY,
        self::VERIFICATION_STATUS_REASON_BLACKLISTED,
        self::VERIFICATION_STATUS_REASON_SHOP_FORMAL_REQUIREMENTS,
        self::VERIFICATION_STATUS_REASON_NEED_FEEDBACK,
    ];

    public const CARD_DATA_ISSUER_VISA = 'VISA';
    public const CARD_DATA_ISSUER_MASTERCARD = 'MASTERCARD';
    public const CARD_DATA_ISSUER_MAESTRO = 'MAESTRO';
    public const CARD_DATA_ISSUER_AMERICAN_EXPRESS = 'AMERICAN EXPRESS';
    public const CARD_DATA_ISSUER_DISCOVER = 'DISCOVER';
    public const CARD_DATA_ISSUER_DINERS = 'DINERS';
