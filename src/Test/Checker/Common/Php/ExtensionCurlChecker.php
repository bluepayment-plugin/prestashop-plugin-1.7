...
/**
 * Checker for PHP CURL extension
 */
final class ExtensionCurlChecker implements CheckerInterface
{
    /**
     * @var \Module
     */
    ...
    {
        return $this->module->l('PHP CURL Extension Check');
    }
    ...
    {
        return $this->module->l('Checks if the PHP CURL extension is installed');
    }
}
