...
<ul class="bm-list-icon" style="margin-top: 20px;">
	<li class="bm-list-icon__item">
		<img class="bm-list-icon__icon" src="{$src_img|escape:'html':'UTF-8'}/icons/idea.svg"
		     alt="{l s='Read the materials' mod='bluepayment'}">
		<div class="bm-list-icon__content">
			<h4 class="bm-list-icon__heading">
				{l s='Read the materials' mod='bluepayment'}
			</h4>
            <ul class="bm-list">
                <li>
	...
	<li class="bm-list-icon__item">
		<img class="bm-list-icon__icon" src="{$src_img|escape:'html':'UTF-8'}/icons/mail.svg"
		     alt="{l s='Contact us' mod='bluepayment'}">
		<div class="bm-list-icon__content">
			<h4 class="bm-list-icon__heading">
