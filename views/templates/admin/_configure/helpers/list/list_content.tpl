		...
		{foreach $fields_display AS $key => $params}
			...
			{block name="td_content"}
				...
				{if isset($params.color) && isset($tr[$params.color])}
					<span class="label color_field" style="background-color:{$tr[$params.color]|escape:'html':'UTF-8'};color:{if !Tools::isBright($tr[$params.color])}white{else}#383838{/if}">
				{/if}
				{if isset($tr.$key)}
	...
	<tr>
		<td class="list-empty" colspan="{(count($fields_display)+1)|escape:'html':'UTF-8'}">
			<div class="list-empty-msg">
				...
				{l s='No records found' mod='bluepayment'}
			</div>
		</td>
	</tr>
{/if}
