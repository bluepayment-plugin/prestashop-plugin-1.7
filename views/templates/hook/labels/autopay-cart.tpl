...
*}
<div class="autopay-container autopay-cart"
     data-uid="{$userId}"
     data-cart_id="{$cartId}"
     data-currency="{$currency}"
     data-currency_iso="{$currency_iso}"
     data-action="{$base}apc/V1/autopay/create-order-from-cart"
     ...
     style="margin-top:{$apc_button_margintop}px; margin-bottom: {$apc_button_marginbottom}px; padding: 15px;"></div>
